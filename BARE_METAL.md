...
```
# VITE_API_BASE='http://103.186.184.179:3001/api' # Use this URL when developing locally
...
AnythingLLM should now be running on `http://103.186.184.179:3001`!
...
curl -I "http://103.186.184.179:3001/api/env-dump" | head -n 1|cut -d$' ' -f2
